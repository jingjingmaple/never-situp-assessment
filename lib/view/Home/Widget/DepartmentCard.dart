    ...
    return InkWell(
      onTap: () {
        if (departmentItem != null) {
          context
              .read<ProductBloc>()
              .add(SetActiveDepartment(department: departmentItem!));
          context
              .read<ProductBloc>()
              .add(GetProduct(departmentId: departmentItem!.id));
        }
      },
      child: Card.outlined(
          ...
          child: AspectRatio(
            ...
            child: Container(
              ...
              children: [
                Image.network(
                    '${departmentItem?.imageUrl}?${DateTime.now().millisecondsSinceEpoch.toString()}'),
                Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(
                                fontSize: 15, color: ColorTheme.blackPrimary),
                          ),
                        )),
                  ),
                ),
