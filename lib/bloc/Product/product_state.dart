...
class ProductState extends Equatable {
  ...
  ProductState copyWith({
    ...
    return ProductState(
      ...
      getProductErrorMessage: getProductErrorMessage ?? this.getProductErrorMessage,
  ...
  @override
  List<dynamic> get props => [departmentList, productList, activeDepartment, isGetProductError];
}